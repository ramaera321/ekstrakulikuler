        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i><strong>Produksi</strong>
            </div>
            <div class="card-body">
                  ...
                  <td>
                    <div class="form-group row">
                      <form action="<?= site_url('produksi/c_produksi/hapus/' . $p->Id_produksi) ?>" method="post">
                        ...
                        <fieldset>
                          <a href="<?= site_url('produksi/c_produksi/detail/' . $p->Id_produksi) ?>">
                            <button type="button" class="btn btn-warning btn-dark">Lihat</button>
                          </a>
                        </fieldset>
