...
class C_pengetahuan2 extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('pengetahuan/M_pengetahuan2');
    ...
    // $data['username']   = $this->M_pengetahuan2->hal1($Id);
       
    // $this->load->view('pengetahuan/list_baru', $data);
        $jumlah_data= $this->M_pengetahuan2->jumlah_data();
        $this->load->library('pagination');
        $config['base_url'] = base_url().'index.php/pengetahuan/C_pengetahuan2/index/';
       ...
       $config['first_link']       = 'First';
        ...
        $data['pengetahuan'] = $this->M_pengetahuan2->page($config['per_page'],$from);
       
      
     $data['pagination'] = $this->pagination->create_links();
		$this->load->view('pengetahuan/list_tanggal2',$data);

	}

    public function lihat($tgl=null){

$data['detail_tanggal']   = $this->M_pengetahuan2->hal($tgl);
$data['username']   = $this->M_pengetahuan2->hal($tgl);
   
$this->load->view('pengetahuan/list_pengetahuan2', $data);
 ...
 redirect(site_url('pengetahuan/C_pengetahuan'));
    }elseif ($this->M_pengetahuan2->hapus($id)) {
